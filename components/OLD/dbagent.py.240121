...
import pymongo
import urllib
from .config_db import * ### When exec from main
#from config_db import * # DEBUG
...
def db_find_test(arg1_collection):
    db_find_result = db_core_collection(mongodb_dbname, arg1_collection).find()
    result_list = []
